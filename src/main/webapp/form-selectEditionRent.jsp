...
<script>
            ...
            if (xhr.readyState == 4) {
                ...
                data.map(d => {
                    ...
                    if (actions.includes('create-rent')) {
                        ...
                        action.setAttribute('onclick', 'location.href="./form-rent.jsp?editionId=' + d['editionId'] + '&email=' + email +'";');
    ...
    // Printing editions
    printTable(elementId = 'editionsTbl', servlet = 'list-editions', columns = ['editionId', 'description', 'releaseyear', 'authorId', 'bookId'], actions = ['create-rent']);
</script>
</body>
</html>
